...
func GetCopilotTeamMetrics(ctx context.Context, g *GitHubClient, org, teamSlug string, since, until *time.Time) ([]*github.CopilotMetrics, error) {
...
func GetEnterpriseTeamMetrics(ctx context.Context, g *GitHubClient, enterprise, teamSlug string, since, until *time.Time) ([]*github.CopilotMetrics, error) {
